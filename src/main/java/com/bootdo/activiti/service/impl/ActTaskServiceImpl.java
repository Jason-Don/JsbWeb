...
//        vars.put("title","");
    ...
    public ProcessInstance startProcess(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
        ...
        runtimeService.setProcessInstanceName(procIns.getProcessInstanceId(), title);
     ...
     */
    @Override
    public ProcessInstance startProcessBySystem(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
        String userId = "System";//ObjectUtils.toString(UserUtils.getUser().getId())
    ...
    public String getFormKey(String procDefId, String taskDefKey) {
        ...
        if (StringUtils.isNotBlank(procDefId)) {
            if (StringUtils.isNotBlank(taskDefKey)) {
                try {
                    //formKey = formService.getTaskFormKey(procDefId, taskDefKey);//获取不到formkey
                    formKey = formService.getTaskFormData(taskDefKey).getFormKey();//modify by zhangf 20180622
                } catch (Exception e) {
                    formKey = "";
                }
            }
