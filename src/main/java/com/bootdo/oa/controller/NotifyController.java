...
public class NotifyController extends BaseController {
	...
	public PageUtils list(@RequestParam Map<String, Object> params) {
		// 查询列表数据
		params.put("createBy", getUserId());//权限控制 add by zhangf 20180214
	...
	@PostMapping("/save")
	@RequiresPermissions("oa:notify:add")
	public R save(@RequestParam("files") MultipartFile file, HttpServletRequest request) throws IOException {
